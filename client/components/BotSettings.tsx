...
export default function BotSettings({ onConfigChange, onBotNameUpdate, onConnect, onSessionReset, onKoreSessionUpdate, userId }: Props) {
    ...
    const [config, setConfig] = useState<BotConfig>({
        clientId: 'cs-6a9cf22f-427a-5c57-8f1c-cd956f1f588d',
        clientSecret: 'BaNB/TNSXvHXh7nHlxwFR34g1TOYTChAxw7tt164R4M=',
        botId: 'st-fc6cabf9-3405-5bd0-b437-75eda54cf0cf',
        webhookUrl: 'https://platform.kore.ai/chatbot/v2/webhook/st-fc6cabf9-3405-5bd0-b437-75eda54cf0cf',
