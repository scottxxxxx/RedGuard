...
const RedGuardIntro = () => {
    ...
    const steps = [
        ...
        },
        {
            ...
            description: "Configure guardrail settings by importing an App Definition file from your bot, or manually select which safety policies to test against your deployed configuration.",
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
