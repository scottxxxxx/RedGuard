  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="relative max-w-md w-full mx-4">
        <div className="bg-[var(--surface)] rounded-2xl shadow-2xl border border-[var(--border)] p-8">
          {/* Close button */}
          <button
            onClick={onClose}
          ...
          {/* Lock Icon */}
          <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-[var(--primary-50)] flex items-center justify-center">
            <svg
          ...
          <p className="text-sm text-[var(--foreground-secondary)] text-center mb-6">
            Sign in with your Google account to use this feature and save your evaluation history.
          </p>
