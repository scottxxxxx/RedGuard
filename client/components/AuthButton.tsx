...
export default function AuthButton() {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center gap-2 px-3 py-1.5 text-sm text-[var(--foreground-muted)]">
        Loading...
      </div>
    );
  }
  ...
  if (!isAuthenticated) {
    return (
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-[var(--primary-600)] hover:bg-[var(--primary-700)] rounded-lg transition-colors"
      >
