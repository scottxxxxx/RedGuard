                    ...
                    {showPromptManager && (
                        <div className="p-3 space-y-3 bg-white border-t border-gray-200">
                            ...
                            <div className="flex flex-col gap-2 bg-gray-50 p-2 rounded border border-gray-200">
                                    ...
                                    <div className="flex-1 min-w-[120px] flex gap-2 items-center">
                                        <div className="flex-1 relative">
                                            <select
                                                ...
                                                className="w-full text-xs border border-gray-300 rounded-md px-2 py-1.5 bg-white focus:ring-1 focus:ring-indigo-500 outline-none appearance-none"
                                            >
                                    ...
                                    <div className="flex gap-1.5">
                                        {currentPromptId ? (
                                            <button
                                                ...
                                                className="flex items-center gap-1 text-xs px-2.5 py-1.5 bg-indigo-50 text-indigo-600 rounded-md hover:bg-indigo-100 border border-indigo-200 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                                            >
                                ...
                                {isSaving && (
                                    <div className="mt-2 bg-indigo-50 p-3 rounded-lg border border-indigo-200 animate-in fade-in slide-in-from-top-2 duration-200 shadow-inner">
                                        <div className="flex items-center gap-2 mb-2 text-[10px] font-bold text-indigo-700 uppercase tracking-wider">
                                        ...
                                        <div className="flex gap-2 items-center">
                                            <input
                                                ...
                                                className="text-xs border border-gray-300 rounded px-2 py-2 flex-1 bg-white focus:ring-2 focus:ring-indigo-500 outline-none shadow-sm"
                                                autoFocus
                                                onKeyDown={e => {
