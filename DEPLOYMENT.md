...
# EXTERNAL_IP should show: 34.59.26.251
```
...
- **Production Server**: GCP Compute Engine VM @ 34.59.26.251
...
|------------|-------------|---------------------|
| `GCP_HOST` | GCP VM IP address | `34.59.26.251` |
...
```bash
NEXT_PUBLIC_API_URL=http://34.59.26.251:3001/api
```
...
```bash
# Check client
curl http://34.59.26.251

# Check server API
curl http://34.59.26.251:3001/api/health

# View in browser
open http://34.59.26.251
```
...
ssh -i ~/.ssh/your-key your-username@34.59.26.251
...
```bash
# SSH into VM
ssh your-username@34.59.26.251
...
ssh your-username@34.59.26.251 "df -h"
...
# Full API test
curl http://34.59.26.251:3001/api/prompts
...
4. Check `GCP_HOST` secret is correct: `34.59.26.251`
...
# 4. Test connection
ssh -i ~/.ssh/redguard-deploy github-actions@34.59.26.251
```
...
**URLs**:
- Client: http://34.59.26.251
- Server: http://34.59.26.251:3001
